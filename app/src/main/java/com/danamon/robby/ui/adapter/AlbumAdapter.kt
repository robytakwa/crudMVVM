package com.danamon.robby.ui.adapter
...
import com.danamon.robby.databinding.AlbumAdapterBinding
        ...
        holder.binding.apply {
            if (albumList != null) {
                if (albumList?.get(position) != null) {
                    ...
                    photosList =
                        (context as DashboardActivity).getPhotosByID(album?.id!!) as ArrayList<PhotosItem?>?
